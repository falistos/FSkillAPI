...
public class PlayerStaminaLossEvent extends Event implements Cancellable
{

    private static final HandlerList handlers = new HandlerList();
    private PlayerData player;
    private StaminaCost source;
     ...
     * @param source the cause of the stamina loss
     */
    public PlayerStaminaLossEvent(PlayerData player, double amount, StaminaCost source)
    {
        this.player = player;
        this.source = source;
        this.amount = amount;
    ...
    public void setAmount(double amount)
    {
        if (amount < 0)
        {
            throw new IllegalArgumentException("Regenerated stamina cannot be negative");
        }
